...
class PlanSimpTextSimplificationEvaluation(Base):
    """Plan-Simp (plan-guided document simplification) results per dataset item."""

    __tablename__ = "plan_simp_text_simplification_evaluation"
