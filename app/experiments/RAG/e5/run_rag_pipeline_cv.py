"""
RAG pipeline (CV, E5 embeddings): evaluate one complement fold at a time.

Usage (from repo root):

    python -m app.experiments.RAG.e5.run_rag_pipeline_cv \\
...
from app.experiments.RAG.e5.retrieval import retrieve_top_k_cv
...
async def run_pipeline(
    ...
    try:
        ...
        print(
            f"E5 RAG CV pipeline: model={model}, description={description_out}, "
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run E5 RAG pipeline (CV fold).")
