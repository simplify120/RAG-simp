"""
run_rag_pipeline.py (BGE version)
---------------------------------
RAG pipeline for text simplification using BGE embeddings.
"""
...
from app.experiments.RAG.bge.retrieval import retrieve_top_k
...
async def run_pipeline(
    ...
    try:
        ...
        print(f"BGE RAG pipeline: model={model}, description={description}, top_k={top_k}")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run BGE RAG pipeline.")
