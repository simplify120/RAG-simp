...
from transformers import RobertaTokenizer, RobertaForSequenceClassification, AutoModelForSequenceClassification, AutoConfig
...
# Windows: multiprocessing spawn + DataLoader workers → MemoryError / EOFError; use main process only.
_DEFAULT_DATALOADER_NUM_WORKERS = 0 if os.name == "nt" else 32
...
def run_classifier(model_ckpt, test_set, x_col="complex", max_samples=None, tokenizer=None, device="cuda", batch_size=16, num_workers=_DEFAULT_DATALOADER_NUM_WORKERS,
